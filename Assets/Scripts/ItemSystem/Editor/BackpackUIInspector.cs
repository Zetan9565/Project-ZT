...
public class BackpackUIInspector : Editor
{
    ...
    private void OnEnable()
    {
        ...
        //tabsGroup = serializedObject.FindProperty("tabsGroup");
    ...
    public override void OnInspectorGUI()
    {
        ...
        //EditorGUILayout.PropertyField(tabsGroup, new GUIContent("标签组"));
        ...
        EditorGUILayout.PropertyField(openButton, new GUIContent("背包按钮"));
