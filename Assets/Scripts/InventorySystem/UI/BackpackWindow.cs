...
namespace ZetanStudio.InventorySystem.UI
{
    ...
    public class BackpackWindow : InventoryWindow
    {
        ...
        protected override ButtonWithTextData[] GetSlotButtons(ItemSlotEx slot)
        {
            ...
            else
            {
                ...
                if (slot.Item.Discardable)
                    ...
                    {
                        InventoryUtility.OpenDiscardItemPanel(Handler, slot.Data.item, slot.transform.position);
                    }));
            }
        ...
        protected override void OnAwake()
        {
            ...
            {
                WindowsManager.OpenWindowBy<CraftWindow>(CraftToolInformation.Handwork, Handler);
            });
        }
    }
}