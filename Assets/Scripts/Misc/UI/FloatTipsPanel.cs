...
namespace ZetanStudio.UI
{
    public class FloatTipsPanel : Window
    {
        ...
        protected override bool OnOpen(params object[] args)
        {
            ...
            Utility.SetActive(tipBackground.gameObject, true);
            Utility.SetActive(tipsContent.gameObject, true);
        ...
        {
            if (hideNameCoroutine != null) StopCoroutine(hideNameCoroutine);
            Utility.SetActive(tipsContent.gameObject, false);
        ...
        IEnumerator FixTextWidth()
        {
            while (true)
            {
                if (IsOpen)
                {
                    ...
                    Utility.KeepInsideScreen(tipBackground);
                    yield return wait;
                }
