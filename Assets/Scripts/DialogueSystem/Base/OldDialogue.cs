...
public class OldDialogue : ScriptableObject
{
    ...
    {
        public static string GetAutoID(OldDialogue[] all, int length = 6)
        {
        ...
        public static bool IsIDDuplicate(OldDialogue dialogue, OldDialogue[] all)
        {
            OldDialogue find = Array.Find(all, x => x.ID == dialogue.ID);
...
public class WordsOption
{
    ...
    public OldDialogue Dialogue => dialogue;
