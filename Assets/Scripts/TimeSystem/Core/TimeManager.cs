...
namespace ZetanStudio.TimeSystem
{
    using SavingSystem;
    ...
    public class TimeManager : SingletonMonoBehaviour<TimeManager>
    {
        ...
        public static string WeekDayToString(DayOfWeek dayOfWeek, ClockSystem timeSystem = ClockSystem.System24)
        {
            DayOfWeek day = dayOfWeek;
            switch (day)
            {
                case DayOfWeek.Monday:
                    return timeSystem == ClockSystem.Twelve ? "月曜" : "星期一";
                case DayOfWeek.Tuesday:
                    return timeSystem == ClockSystem.Twelve ? "金曜" : "星期二";
                case DayOfWeek.Wednesday:
                    return timeSystem == ClockSystem.Twelve ? "木曜" : "星期三";
                case DayOfWeek.Thursday:
                    return timeSystem == ClockSystem.Twelve ? "水曜" : "星期四";
                case DayOfWeek.Friday:
                    return timeSystem == ClockSystem.Twelve ? "火曜" : "星期五";
                case DayOfWeek.Saturday:
                    return timeSystem == ClockSystem.Twelve ? "土曜" : "星期六";
                case DayOfWeek.Sunday:
                default:
                    return timeSystem == ClockSystem.Twelve ? "日曜" : "星期日";
            }
        }
        ...
        [SerializeField]
        private ClockSystem clockSystem = ClockSystem.System24;
        ...
        public string DateString
        {
            get
            {
                ...
                return Date.ToString(clockSystem);
            }
        }
        ...
        public class DateInfo
        {
            ...
            public string GetMonthString(ClockSystem clockSystem)
            {
                string monthString = (int)month + "月";
                if (clockSystem == ClockSystem.Twelve)
                {
            ...
            public string GetDayOfMonthString(ClockSystem clockSystem)
            {
            ...
            public string GetWeekDayString(ClockSystem clockSystem)
            {
                return dayOfWeek switch
                {
                    DayOfWeek.Monday => clockSystem == ClockSystem.Twelve ? "月曜" : "星期一",
                    DayOfWeek.Tuesday => clockSystem == ClockSystem.Twelve ? "金曜" : "星期二",
                    DayOfWeek.Wednesday => clockSystem == ClockSystem.Twelve ? "木曜" : "星期三",
                    DayOfWeek.Thursday => clockSystem == ClockSystem.Twelve ? "水曜" : "星期四",
                    DayOfWeek.Friday => clockSystem == ClockSystem.Twelve ? "火曜" : "星期五",
                    DayOfWeek.Saturday => clockSystem == ClockSystem.Twelve ? "土曜" : "星期六",
                    _ => clockSystem == ClockSystem.Twelve ? "日曜" : "星期日",
                };
            }

            public string ToString(ClockSystem clockSystem = ClockSystem.System24)
            {
                return GetMonthString(clockSystem) + GetDayOfMonthString(clockSystem) + " " + GetWeekDayString(clockSystem);
            }
        }
    }
}