...
namespace ZetanStudio.GatheringSystem.Editor
{
    [CustomEditor(typeof(ResourceInformation))]
    public class ResourceInfoInspector : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(productItems, new GUIContent("产出道具"));
