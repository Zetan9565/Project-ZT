    ...
    public class StructureManageWindow : InteractionWindow<Interactive2D>, IHideable
    {
        ...
        protected override bool OnOpen(params object[] args)
        {
            ...
            if (args[0] is Structure2D structure)
            {
                ...
                Utility.SetActive(manageButton, CurrentStructure.Info.Manageable);
            ...
            else if (args[0] is StructurePreview2D preview)
            {
                ...
                Utility.SetActive(manageButton, !CurrentPreview.Data.Info.AutoBuild);
        ...
        {
            base.OnClose(args);
            Utility.SetActive(morePanel, false);
        ...
        {
            Utility.SetActive(morePanel, !morePanel.activeSelf);
        }
