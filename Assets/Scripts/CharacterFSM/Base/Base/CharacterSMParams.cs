...
{
    [SerializeField, DisplayName("行走速度")]
    private float walkSpeed = 5;
    public float WalkSpeed => walkSpeed;

    [SerializeField, DisplayName("闪现距离")]
    private float dashDistance = 5;
    public float DashDistance => dashDistance;

    [SerializeField, DisplayName("翻滚速度曲线")]
    ...
    [SerializeField, DisplayName("翻滚速度生效时间"), MinMaxSlider(0, 1)]
    private Vector2 rollEffectedTime = Vector2.up;
    public Vector2 RollEffectedTime => rollEffectedTime;

    [SerializeField, DisplayName("可提前退出翻滚时间"), MinMaxSlider("rollEffectedTime")]
