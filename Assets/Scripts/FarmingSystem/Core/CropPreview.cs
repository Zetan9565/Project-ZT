...
public class CropPreview : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (gameObject.layer != LayerMask.NameToLayer("CropPreview"))
            gameObject.layer = LayerMask.NameToLayer("CropPreview");
    ...
    {
        if (!collision.isTrigger || collision.GetComponent<Crop>())
        {
