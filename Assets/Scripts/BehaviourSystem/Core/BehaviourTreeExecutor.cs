...
namespace ZetanStudio.BehaviourTree
{
    public class BehaviourTreeExecutor : MonoBehaviour
    {
        ...
        private void Prepare(bool execute)
        {
            ...
            behaviour.Init(this);
            if (this is not ScenedBehaviourTreeExecutor) behaviour.PresetVariables(presetVariables);
            if (execute) behaviour.Execute();
        }

        public void SetBehaviour(BehaviourTree tree, bool executeImmediate)
        {
            if (this is ScenedBehaviourTreeExecutor && !tree.ScenceOnly)
            {
        ...
        private void Start()
        {
            if (BehaviourTreeManager.Instance) BehaviourTreeManager.Instance.Add(this);
        ...
        {
            if (BehaviourTreeManager.Instance) BehaviourTreeManager.Instance.Remove(this);
        }
        #endregion
