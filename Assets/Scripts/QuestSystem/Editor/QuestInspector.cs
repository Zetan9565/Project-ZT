        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (barIndex)
            {
                case 0:
                    ...
                    EditorGUILayout.TextArea(Keyword.Editor.HandleKeywords(title.stringValue) + "\n" + Keyword.Editor.HandleKeywords(description.stringValue), new GUIStyle(EditorStyles.textArea) { wordWrap = true });
            ...
            objectiveList = new ReorderableList(serializedObject, objectives, true, true, true, true)
            {
                ...
                onAddDropdownCallback = (rect, list) =>
                {
                    ...
                    void OnAddOption(object data)
                    {
                        ...
                        type.GetField("priority", Utility.CommonBindingFlags).SetValue(objective, quest.Objectives.Count + 1);
